...
exports.handler = async (event, context) => {
  console.log("Plano webhook function called with event:", {
  ...
  try {
    ...
    try {
      ...
      console.log('Plano webhook received data:', data);
    } catch (parseError) {
    ...
    try {
      ...
      const mightycallEvent = {
        ...
        body: JSON.stringify({
          ...
          message: "Hi, this is Griffin with Scratch Golf Club! I saw that you were interested in joining our club in Plano. Would you like to reserve your spot on the waitlist?"
        }),
