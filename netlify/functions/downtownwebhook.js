...
exports.handler = async (event, context) => {
  console.log("Downtown webhook function called with event:", {
  ...
  try {
    ...
    try {
      ...
      console.log('Downtown webhook received data:', data);
    } catch (parseError) {
    ...
    try {
      ...
      const mightycallEvent = {
        ...
        body: JSON.stringify({
          ...
          message: "Hi, this is Griffin with Scratch Golf Club! I saw that you were interested in joining our club downtown. Are you ready to join as a member or would you like to come in for a trial to experience the facility first?"
        }),
